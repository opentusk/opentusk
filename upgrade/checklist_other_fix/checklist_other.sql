...
(0, 'user.source_id', 'internal', 'Internal', 'Manually and internally maintained', 'script', now()),
(0, 'user.source_id', 'external', 'Authentication', 'Externally maintained eg LDAP', 'script', now()),
(0, 'user.source_id', 'checklist', 'Competency Checklist App', 'Generated by competency checklist application', 'script', now()),
(0, 'user.source_id', 'evaluation', 'Evaluation App', 'Generated by competency checklist application', 'script', now()),
;
