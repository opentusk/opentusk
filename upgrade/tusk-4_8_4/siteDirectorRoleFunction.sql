...
SET @x_role_id = 0;
SET @x_function_id = 0;
INSERT INTO tusk.permission_function (function_token, function_desc, created_by, created_on, modified_by, modified_on) VALUES ('view_site_grades', 'View site grades', 'script', NOW(), 'script', NOW());
