package TUSK::ShibbolethUser;

=head1 NAME

B<TUSK::ShibbolethUser> - Class for manipulating entries in table shibboleth_user in tusk database
...
TUSK::ShibbolethUser->isShibUser($user_id);
