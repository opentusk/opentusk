...
package TUSK::Content::External::Source::PubMed;

=head1 NAME

B<TUSK::Content::External::Source::PubMed> - Class for handling external content from the PubMed source
