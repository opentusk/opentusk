...
package TUSK::FormBuilder::Form::Attribute;

=head1 NAME

B<TUSK::FormBuilder::Form::Attribute> - Class for manipulating entries in table form_builder_form_attribute in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'form_builder_form_attribute',
