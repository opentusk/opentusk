...
package TUSK::FormBuilder::FormType;

=head1 NAME

B<TUSK::FormBuilder::FormType> - Class for manipulating entries in table form_builder_form_type in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'form_builder_form_type',
