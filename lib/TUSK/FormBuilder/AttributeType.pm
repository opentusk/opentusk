...
package TUSK::FormBuilder::AttributeType;

=head1 NAME

B<TUSK::FormBuilder::AttributeType> - Class for manipulating entries in table form_builder_attribute_type in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'form_builder_attribute_type',
