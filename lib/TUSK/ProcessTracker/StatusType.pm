...
package TUSK::ProcessTracker::StatusType;

=head1 NAME

B<TUSK::ProcessTracker::StatusType> - Class for manipulating entries in table process_tracker_status_type in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'process_tracker_status_type',
					'usertoken' => '',
					'database_handle' => '',
					},
				    _field_names => {
					'process_tracker_status_type_id' => 'pk',
					'token' => '',
					'label' => '',
					'description' => '',
				    },
