...
package TUSK::Competency::ClassMeeting;

=head1 NAME

B<TUSK::Competency::ClassMeeting> - Class for manipulating entries in table class_meeting_competency in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'competency_class_meeting',
					'usertoken' => '',
					'database_handle' => '',
					},
				    _field_names => {
					'competency_class_meeting_id' => 'pk',
					'competency_id' => '',
					'class_meeting_id' => '',
					'sort_order' => '',
				    },
