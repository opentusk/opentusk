...
package TUSK::Core::CompetencyRelationship;

=head1 NAME

B<TUSK::Core::CompetencyRelationship> - Class for manipulating entries in table competency_relationship in tusk database
...
sub new {
    ...
    my $self = $class->SUPER::new ( 
				    _datainfo => {
					'database' => 'tusk',
					'tablename' => 'competency_relationship',
					'usertoken' => '',
					'database_handle' => '',
					},
				    _field_names => {
					'competency_relationship_id' => 'pk',
					'school_id' => '',
					'lineage' => '',
