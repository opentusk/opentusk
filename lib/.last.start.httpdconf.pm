...
my %serverDesignations = (
 	'tusk-gold.tusk.tufts.edu'      	=> 'PROD',
 	'tusktest-fe01.tusk.tufts.edu'      => 'TEST',
 	'tusktest-fe02.tusk.tufts.edu'      => 'TEST',
	'tuskdev-dan01.tusk.tufts.edu'      => 'TEST',
	'tuskdev-isarin01.tusk.tufts.edu'   => 'TEST',
	'tuskdev-john01.tusk.tufts.edu'     => 'TEST',
	'tuskdev-rebecca01.tusk.tufts.edu'	=> 'TEST',
	'tuskdev-sean01.tusk.tufts.edu'     => 'TEST',
	'tuskdev-sean02.tusk.tufts.edu'     => 'TEST',
	'tusk-fe01.tusk.tufts.edu'      	=> 'PROD',
	'tusk-fe02.tusk.tufts.edu'      	=> 'PROD',
	'tusk-fe03.tusk.tufts.edu'      	=> 'PROD',
	'tusk-fe04.tusk.tufts.edu'      	=> 'PROD',
	'tusk-fe05.tusk.tufts.edu'      	=> 'PROD',
	'tusk-fe06.tusk.tufts.edu'      	=> 'PROD',
);
...
sub setVariablesForServerEnvironment($) {
  ...
  ${$hashOfVariablesRef}{'allowStatusFrom'}      = '130.64.2';
  ...
  unless(exists($serverDesignations{$hostname})) {
    ...
    if ( ! defined $zone || $zone eq 'global' ) {
      ...
      ## kato is the development machine
      ${$hashOfVariablesRef}{'server_name'}      = 'dev.' . $TUSK::Constants::Domain;
      ${$hashOfVariablesRef}{'ip_address'}       = '130.64.1.96';
      ${$hashOfVariablesRef}{'ssl_cert_file'}    = "self.dev.tusk.tufts.edu.cert";
      ${$hashOfVariablesRef}{'ssl_key_file'}     = "dev.tusk.tufts.edu.key.pub";
