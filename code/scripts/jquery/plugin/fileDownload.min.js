...
if(isFailure)downloadWindow.close()}}},0)}function htmlSpecialCharsEntityEncode(str){return str.replace(htmlSpecialCharsRegEx,function(match){return"&"+htmlSpecialCharsPlaceHolders[match]})}return deferred.promise()}})})(jQuery,this);
