    ...
    function o(a, b, c) {
        if (null != a) {
            for (var s = CKEDITOR.tools.getNextId() + "_symbol_table_label", i = [""], h = 0, d = 0, j = !1, f, g, k = a.split(","), l = 0; l < k.length; l++) {
                ...
                h += a - f + 1;
                if (a >= f)
                    for (j || (i.push('<table role="listbox" aria-labelledby="' + s + '" style="width: 100%; height: 100%; border-collapse: separate;" align="center" cellspacing="2" cellpadding="2" border="0">'), j = !0); f <= a;) {
                        0 == d && i.push("<tr>");
    ...
    var m = "&nbsp;",
        ...
        u = CKEDITOR.tools.addFunction(function (a) {
            ...
            case 38:
                ...
                break;
            case 40:
                if (c = b.getParent().getParent().getNext())
                    if ((c = c.getChild([b.getParent().getIndex(), 0])) && 1 == c.type) c.focus(), h(null, b), g(null, c);
                a.preventDefault();
                break;
            case 32:
                p({
            ...
            case d ? 37:
                ...
                else if (c = b.getParent().getParent().getNext())(c = c.getChild([0,
                    0
        ...
        onShow: function () {
            ...
            if (0 < a.childNodes.length) {
                ...
                for (var c = 0, d = 0; d < a.childNodes.length; d++)
                    if (console.log(d + " domElement.childNodes[i].text = " + a.childNodes[d].text),
