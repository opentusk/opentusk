...
<!ENTITY % entitiesDTD PUBLIC
   ...
   "/usr/local/tusk/current/code/HSCML/Rules/entities.dtd">
%entitiesDTD;

<!ENTITY % HTMLlat1 PUBLIC
   "-//W3C//ENTITIES Latin 1 for XHTML//EN"
   "/usr/local/tusk/current/code/HSCML/Rules/XMLlat1pdf.ent">
%HTMLlat1;

<!ENTITY % HTMLsymbol PUBLIC
   "-//W3C//ENTITIES Symbols for XHTML//EN"
   "/usr/local/tusk/current/code/HSCML/Rules/XMLsymbolpdf.ent">
%HTMLsymbol;

<!ENTITY % HTMLspecial PUBLIC
   "-//W3C//ENTITIES Special for XHTML//EN"
   "/usr/local/tusk/current/code/HSCML/Rules/XMLspecialpdf.ent">
%HTMLspecial;
]>
